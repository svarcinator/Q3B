 ...
 (($x5110
   (forall
    ...
    (($x3485
      ...
      (not (bvsle (ite MW_S2_V2 S2_V2_!6455 ?x3208) ?x2657))
      (bvsge ?x3058 (bvadd (bvneg (_ bv1 32)) ?x4184)) 
      (not (bvsle V2_0 E1_!6463)) 
      (not (bvsle ?x3664 ?x3750)) 
      (bvsge ?x2995 (bvadd (bvneg (_ bv1 32)) ?x3727)))))
    ...
    (($x2750
      (and
      (or (not R_S1_V1)
      (= E1_!6463 (bvadd (_ bv1 32) (ite MW_S1_V1 S1_V1_!6442 E1_!6441)))) $x2934 $x2702
      $x2976 $x3213)))
    (let
    (($x2729
      (or
    ...
    (($x2660
      (and
      (or (not R_S1_V1)
      (= E1_!6441 (bvadd (_ bv1 32) (ite MW_S1_V1 S1_V1_!6442 E1_!6441)))) $x2934 $x2702
      $x2976 $x3213)))
    ...
    (let
    (($x2962
      (and (or (not R_S1_V1) (= ?x3808 (bvadd (bvneg (_ bv1 32)) E1_!6463))) $x3321 $x3401
      $x3396 $x3682)))
    (let (($x2691 (not $x2962)))
    (let
    (($x2783
      (and (or (not R_S1_V1) (= ?x3808 (bvadd (bvneg (_ bv1 32)) E1_!6441))) $x3321 $x3401
      $x3396 $x3682)))
    (let (($x3147 (not $x2783)))
    (let
    (($x2889
    ...
    (($x3315
      (and
      (or (not R_S1_V1)
      (= (ite MW_S1_V1 S1_V1_!6442 E1_!6441) (bvadd (bvneg (_ bv1 32)) E1_!6463))) $x2957
      $x2922 $x2673 $x2815)))
    (let (($x2821 (not $x3315)))
    (let
    (($x2925
      (and
      (or (not R_S1_V1)
      (= (ite MW_S1_V1 S1_V1_!6442 E1_!6441) (bvadd (bvneg (_ bv1 32)) E1_!6441))) $x2957
      $x2922 $x2673 $x2815)))
    (let (($x3327 (not $x2925)))
    (let
    (($x3334
