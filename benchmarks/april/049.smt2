 ...
 (($x6721
   (forall
    ...
    (($x2771
      ...
      (not (bvsle ?x4085 ?x4361)) 
      (bvsge ?x4343 (bvadd (bvneg (_ bv1 32)) ?x4260)) 
      ...
      (not (bvsle (ite MW_S2_V2 S2_V2_!6108 ?x3992) ?x4286))
      (bvsge ?x4252 (bvadd (bvneg (_ bv1 32)) ?x3223)))))
    ...
    (let
    (($x3278
      (and (or (not R_S2_V1) (= ?x4285 (bvadd (bvneg (_ bv1 32)) ?x4363))) $x2656 $x2686
      $x3309 $x2915)))
    (let (($x2872 (not $x3278)))
    ...
    (let
    (($x3491
      (and (or (not R_S2_V1) (= ?x4285 (bvadd (bvneg (_ bv1 32)) ?x4318))) $x2889 $x2769
      $x2780 $x3186)))
    ...
    (($x2881
      (not
      (and (or $x215 (= ?x4285 (bvadd (bvneg (_ bv1 32)) E1_!6105))) $x2618 $x2594 $x3171
      $x3214))))
    ...
    (($x3562
      (and
      (or $x202 (= (ite MW_S1_V1 S1_V1_!6095 E1_!6094) (bvadd (bvneg (_ bv1 32)) E1_!6073)))
    ...
    (let
    (($x2891
      (and (or $x202 (= E1_!6094 (bvadd (_ bv1 32) (ite MW_S1_V1 S1_V1_!6095 E1_!6094))))
    ...
    (($x3974
      (not
      (and (or $x202 (= ?x4344 (bvadd (bvneg (_ bv1 32)) E1_!6073))) $x3885 $x3757 $x3898
      $x3346))))
    ...
    (($x2969
      (and
      (or $x202 (= (ite MW_S1_V1 S1_V1_!6095 E1_!6094) (bvadd (bvneg (_ bv1 32)) E1_!6094)))
      $x3524 $x2856 $x2777 $x3107)))
    ...
    (($x2610
      (not
      (and (or $x202 (= ?x4344 (bvadd (bvneg (_ bv1 32)) E1_!6094))) $x3885 $x3757 $x3898
      $x3346))))
    (let (($x2607 (= S1_V2_!6076 S1_V2_!6102)))
    (let
    (($x3368
      (and (or $x202 (= E1_!6073 (bvadd (_ bv1 32) (ite MW_S1_V1 S1_V1_!6095 E1_!6094))))
      $x2757 $x3451 $x4101 $x3342)))
