...
Bvec Bvec::bvec_mul_nodeLimit_state_prev(const Bvec &left, const Bvec &right, unsigned int nodeLimit, Computation_state &state){
    if (nodeLimit != UINT_MAX) {
        setToBeRecomputedBitsToNoVal(state);
    }
